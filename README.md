...
## 🔥 Summary
A passionate Full-Stack Software Engineer, deep learning researcher, and Master's student in Computer Science at San Francisco State University. I enjoy building multimodal AI systems, full-stack applications, and reliable tools that turn research ideas into practical products.

## 🎓 Education
- **Master of Science in Computer Science**, San Francisco State University (Expected May 2026) - GPA: **3.81 / 4.00**
- **Bachelor of Engineering in Computer Engineering**, Gujarat Technological University (July 2024) - GPA: **3.98 / 4.00**

## 🚀 What I'm Building
- **Multimodal Emotion Detection:** Building audio-visual sentiment analysis pipelines with ResNet-18, transformers, and cross-modal attention.
- **RAG-Based Recommendation Systems:** Matching **10K+** job postings with curriculum data and **1K+** student profiles using Qdrant embeddings and graph-based reranking.
- **Reliable AI Workflows:** Designing evaluation and QA pipelines for multimodal systems with explainable scoring, semantic search, and faster iteration.

## 🧠 Featured Projects
- **Opus.Prism** ([GitHub](https://github.com/chetas1208/opus.Prism) | [Demo](https://drive.google.com/file/d/1EwU8b06NjeCNorqlQ59cAD9vb3WD-tU_/view)) - Built a **5-agent** AI pipeline with Qwen2.5, CrewAI, FastAPI, and Next.js that reduced prompt engineering effort by **80%**, delivered multimodal voice guidance under **500 ms**, and added frame-level QA automation up to **5 FPS**.
- **Sudoku Solver** ([GitHub](https://github.com/chetas1208/Sudoku-Solver) | [Website](https://matthieufouliard.fr/sudokusolver/)) - Developed a PyTorch, OpenCV, FastAPI, and React.js system with **99.86%** digit recognition accuracy and **93.5%** Sudoku grid detection and rectification success.

## 🏆 Awards and Research
- **Gilead Innovation Initiative Summer Research Award** - **$5,000**
- **BMC Scholarship** - **$2,000**
